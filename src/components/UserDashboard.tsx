...
const UserDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'buy' | 'coupons' | 'history' | 'branch'>('dashboard');
                      ...
                      return (
                        ...
                        >
                          <div className="text-center">
                            ...
                            <div className="flex items-center justify-center mt-8 space-x-4 mb-4">
                              <button
